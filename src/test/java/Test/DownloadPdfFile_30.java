...
public class DownloadPdfFile_30 {
    public static void main(String[] args) {
       ...
       /* HashMap preperence=new HashMap();
        preperence.put("plugins.always_open_pdf_externally",true);
...
*/
       ...
       */
        ...
        profile.setPreference("browser.helperApps.neverAsk.saveToDisk","application/pdf");  //mime types
